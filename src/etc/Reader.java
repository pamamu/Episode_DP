...
public class Reader {
    ...
    // CONSTRUCTORES ###########################################################
    public Reader(String archivo) throws IOException {
        datos = "";
        leerFichero(archivo);     //Lectura del fichero
    }
    ...
    private void leerFichero(String archivo) throws FileNotFoundException, IOException {
        ...
        //la entrada
        String ruta = "./files/" + archivo;  //Ruta del fichero de entrada
...
//                    + "configuracion inicial\n" + e.getMessage(), 3);
     ...
     *
     * @param tipo Indica el codigo de tipo de personaje a recoger los datos      <pre>
    * CODIGO:
     *   1 -> JEDI
     *   2 -> CONTRABANDISTA
     *   3 -> FAMILIAREAL
     ...
     * </pre>
     *
     * @return String[numPersonajes][datosPersonaje]      <pre>
...
//                + "tipo " + codigo);
        ...
        while (line.hasNextLine()) {
            ...
            if (preProcesado.startsWith(codigo)) {
                ...
                if (salida != null) //Recorre el array antiguo
                {
...
//        Logger.obtenerInstancia().escribelog("Obteniendo datos de la galaxia");
     ...
     *
     * @return String[][] -Matriz de string      <pre>
    ...
    /**
     * Obtiene la informacion de los Contrabandistas del fichero de
     * configuracion inicial
     *
     * @return String[][] -Matriz de string      <pre>
     *   Primera dimension o filas = numero de personajes
